...
export const LoadingIcon: FC<LoadingIconProps> = (props) => {
    return (
        ...
        <svg aria-hidden="true" className={`mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-white ${props.className}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
